  ...
  return (
    <>
      ...
      <Box sx={{ minHeight: "90vh", display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        ...
        <Typography variant='h4' sx={{ fontWeight: 'bold', mb: 2 }}>Welcome to ConstiFind Admin</Typography>
        ...
        <Box>
          <Button variant='contained' sx={{ backgroundColor: '#000', color: '#fff', fontSize: '18px', px: 4, py: 1, mt: 2, mr: 2 }}>Search</Button>
          <Button variant='contained' sx={{ backgroundColor: '#000', color: '#fff', fontSize: '18px', px: 4, py: 1, mt: 2 }}>Upload or Manage Files</Button>
        </Box>
      </Box>
    </>
  );
